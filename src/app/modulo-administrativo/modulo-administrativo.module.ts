...
import { ComponenteCrearIncidenciaAdministrativoComponent } from './componente-administrativo/componente-incidencias-administrativo/componente-crear-incidencia/componente-crear-incidencia-administrativo.component';
import { ComponenteResumenDatosIncidenciaAdministrativoComponent } from './componente-administrativo/componente-incidencias-administrativo/componente-resumen-datos/componente-resumen-datos-incidencia-administrativo.component';
import { ComponenteConfirmacionIncidenciaAdministrativoComponent } from './componente-administrativo/componente-incidencias-administrativo/componente-confirmacion/componente-confirmacion-incidencia-administrativo.component';
@NgModule({
  declarations: [
